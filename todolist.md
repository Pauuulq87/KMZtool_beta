...
- [已完成] **UI 按鈕功能完善** <!-- id: 37 -->
    - [已完成] 進階分頁「儲存預設值」：LocalStorage 儲存與套用提示 <!-- id: 38 -->
    - [已完成] 下載分頁「分割任務」：下載時依區塊切分 KML/KMZ 檔案 <!-- id: 39 -->
    - [已完成] 下載分頁「下載 KMZ 自動安裝程式 V2」：提供可下載或指引檔案 <!-- id: 40 -->
    - [已完成] 下載分頁「儲存至帳號」：帶入輸入框任務名稱並調用現有保存流程 <!-- id: 41 -->

## 文件與技術資料

- [已完成] **DJI KML/KMZ 技術資料整理** <!-- id: 42 -->
    - [已完成] 使用 Context7 查詢 DJI、KML、KMZ 飛行路徑繪製相關技術資料 <!-- id: 42a -->
    - [已完成] 將查得資訊整理寫入 `DJI_KML_KMZ技術資料.md` <!-- id: 42b -->
